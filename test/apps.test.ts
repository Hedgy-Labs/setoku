...
describe("isFullDoc", () => {
  ...
  it("sees through a leading banner comment / XML prolog before the doctype", () => {
    expect(isFullDoc("<!-- generated by X -->\n<!doctype html><html></html>")).toBe(true);
    expect(isFullDoc('<?xml version="1.0"?>\n<html xmlns="..."></html>')).toBe(true);
    expect(isFullDoc("<!-- a --> <!-- b --> <!doctype html>")).toBe(true); // multiple
  });
