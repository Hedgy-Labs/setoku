...
export const LAKE_SOURCES: LakeSource[] = [
  ...
  { table: "gmail_messages", source: "Gmail", ts: "received_at", blurb: "Personal email — sender, subject, plain-text body (UNTRUSTED free text: anyone can email you). Spam/trash & auth/2FA mail excluded; marketing flagged is_bulk=1 (filter WHERE is_bulk=0). Full archive: history back to the mailbox's oldest mail, 20-yr retention. Mutable rows: query with FINAL", connector: "gmail-poller" },
